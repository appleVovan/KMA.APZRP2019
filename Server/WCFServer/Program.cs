...
using KMA.APZRP2019.WalletSimulator.Server.WCFServer;
...
namespace KMA.APZRP2019.WalletSimulator.Server.WCFServer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            const string serviceName = WalletWCFService.CurrentServiceName;
            ...
            {
                var servicesToRun = new ServiceBase[] {new WalletWCFService(), };
